...
class Alphabet(object):
    ...
    def from_architecture(cls, name: str) -> "Alphabet":
        if name in ("ESM-1", "protein_bert_base"):
            ...
            append_eos = False
            use_msa = False
        elif "esm-aa" in name.lower():
            standard_toks = proteinseq_toks["toks"]
            prepend_toks = ("<cls>", "<pad>", "<eos>", "<unk>")
            append_toks = ("<mask>", "C_a", "N_a", "O_a", "S_a", "H_a", "Cl_a", "F_a", "Br_a", "I_a", "Si_a", "P_a", "B_a", "Na_a", "K_a", "Al_a", "Ca_a", "Sn_a", "As_a", "Hg_a", "Fe_a", "Zn_a", "Cr_a", "Se_a", "Gd_a", "Au_a", "Li_a")
            prepend_bos = True
            append_eos = True
            use_msa = False
        else:
